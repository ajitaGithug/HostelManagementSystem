...
<head>
    ...
    <style>
        ...
        .header {
            display: flex;
            justify-content: center; /* Changed to center the heading */
            align-items: center;
            margin-bottom: 20px;
        }
        ...
        /* Enforce equal width for all form-col elements within form-row */
        .form-row > .form-col {
            flex: 1; /* Distribute available space equally */
            min-width: 0; /* Allow shrinking if necessary, but coupled with max-width on form-container it should behave */
        }
...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form action="add-room-process.jsp" method="post">
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            <label for="college">Block</label>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" id="rate" name="rate" step="0.01" required placeholder="e.g. 210.00">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="roomNumber" name="roomNumber" required placeholder="e.g. S042">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" id="roomLevel" name="roomLevel" required min="0" max="10" placeholder="Floor level">
                        </div>
                    </div>
                    <div class="form-col">
                        </div>
